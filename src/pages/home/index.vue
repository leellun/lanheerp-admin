                ...
                <a-col :span="12">
                    <div class="out-border">
                        ...
                        <div style="padding: 40px">
                            <a-row>
                                <a-col :span="6" class="color-danger overview-item-value">100</a-col>
                                <a-col :span="6" class="color-danger overview-item-value">200</a-col>
                                <a-col :span="6" class="color-danger overview-item-value">1000</a-col>
                                <a-col :span="6" class="color-danger overview-item-value">5000</a-col>
                            </a-row>
                            <a-row class="font-medium">
            ...
            <a-row>
                ...
                <a-col :span="20">
                    <div style="padding: 10px;border-left:1px solid #DCDFE6">
                        <a-date-picker style="float: right;z-index: 1" size="small" v-model="orderCountDate"
...
const getData = () => {
    setTimeout(() => {
        ...
        for (let i = 0; i < DATA_FROM_BACKEND.rows.length; i++) {
            ...
            let currDate = dayjs(item.date, "YYYY-MM-DD").toDate();
            let start = orderCountDate[0];
            let end = orderCountDate[1];
