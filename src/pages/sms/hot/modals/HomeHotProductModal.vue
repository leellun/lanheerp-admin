...
import { _createHotProduct } from '@/api/sms/hotProductApi'
import type { HomeHotProduct } from '@/api/sms/hotProductApi'
...
const handleOk = () => {
    ...
    let selectBrands: Array<HomeHotProduct | any> = [];
    ...
    Modal.confirm({
        ...
        cancelText: "取消",
        onOk: () => {
            _createHotProduct(selectBrands).then(res => {
